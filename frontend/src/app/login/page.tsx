  ...
  return (
    <div className="min-h-screen py-12 flex items-center justify-center bg-white relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-1/4 w-[400px] h-[400px] bg-[#7c2cff]/5 blur-[100px] rounded-full"></div>
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#ff416c]/5 blur-[100px] rounded-full"></div>
      </div>
        ...
        <div className="bg-white border border-slate-100 rounded-[2rem] p-8 shadow-[0_20px_50px_-12px_rgba(67,97,238,0.1)]">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-slate-50/50 border border-slate-100 rounded-xl py-3 pl-10 pr-4 text-sm text-slate-900 placeholder:text-slate-300 focus:outline-none focus:ring-4 focus:ring-[#7c2cff]/5 focus:border-[#7c2cff] transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-slate-50/50 border border-slate-100 rounded-xl py-3 pl-10 pr-10 text-sm text-slate-900 placeholder:text-slate-300 focus:outline-none focus:ring-4 focus:ring-[#7c2cff]/5 focus:border-[#7c2cff] transition-all"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="relative w-full group overflow-hidden py-3 bg-[#7c2cff] text-white rounded-xl font-bold text-sm shadow-lg shadow-[#7c2cff]/20 hover:bg-[#631fcc] transition-all flex items-center justify-center gap-2"
            >
              {isLoading ? (
          ...
          <div className="mt-6 pt-4 border-t border-slate-50 text-center">
            <p className="text-slate-400 text-xs font-bold">
              Belum punya akun?{' '}
              <Link href="/register" className="text-[#7c2cff] hover:underline">Daftar</Link>
            </p>
          </div>
        </div>
